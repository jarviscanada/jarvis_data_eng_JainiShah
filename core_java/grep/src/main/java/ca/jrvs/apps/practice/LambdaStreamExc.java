...
public interface LambdaStreamExc {
   ...
   *
   * note: arbitary number of value will be stored in an array
   *
   * @param strings
   * @return
   */
  Stream<String> createStreamString(String ... strings);
   ...
   * @return
   */
  Stream<String> toUpperCase(String ... string);

  /**
   * filter strings that contains pattern
   * e.g.
  ...
  /**
   * Return a lambda function that print a message with a prefix and a suffix
   * @param prefix
   * @param suffix
   * @return
   */
